package com.example.AndroidDemo.main;
...
import com.example.AndroidDemo.TestAdapter.GuideAdapter;
import com.example.AndroidDemo.TestAdapter.GuideFragment;

import java.util.ArrayList;
import java.util.List;

/**
 * Created by Huangjing on 2020/11/23/8:35 PM
 */

public class SlideShowMainActivity extends FragmentActivity implements ViewPager.OnPageChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.slideshow_activity_main);
